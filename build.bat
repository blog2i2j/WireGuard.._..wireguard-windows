...
:installdeps
	...
	cd .deps || goto :error
	call :download go.zip https://download.wireguard.com/windows-toolchain/distfiles/go1.26.1-windows_amd64_2026-03-20.zip 81d9e356d0a524c471c21f4d1a1198d91afafbf5af74fad41f9456adffd21f58 "--strip-components 1" || goto :error
